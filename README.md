...
| 类别 | 文件 | 说明 |
|---|---|---|
| 知识讲解 | `一元二次方程.typ`、`韦达定理.typ`、`平方根.typ`、`一次函数.typ`、`二次函数.typ`、`初中数学公式.typ` | 求根公式/韦达定理/平方根/一次函数/二次函数讲解 + 26 条公式速查卡（代数/几何/三角函数/统计） |
| 练习卷 | `一元二次方程1/2.typ`、`韦达定理1/2/3.typ`、`平方根1/2.typ`、`因式分解1/2.typ`、`一次函数1/2.typ`、`二次函数1/2.typ` | 共 13 份约 240 题，数字 1/2 为换数换版，`3` 为提高篇 |
